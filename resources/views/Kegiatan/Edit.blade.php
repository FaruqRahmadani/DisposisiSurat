		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal row-border" action="{{ Route('submit-Edit-Kegiatan', ['Id' => Hcrypt::Encrypt($Kegiatan->id)]) }}" method="POST" enctype="multipart/form-data">
						{{csrf_field()}}
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea name="uraian" rows="4" cols="80" class="form-control" required>{{$Kegiatan->uraian}}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-2 control-label">Tempat</label>
							<div class="col-md-10">
								<input type="text" name="tempat" class="form-control" required value="{{$Kegiatan->tempat}}">
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-2 control-label">Keterangan</label>
							<div class="col-md-10">
								<textarea name="keterangan" rows="4" cols="80" class="form-control" required>{{$Kegiatan->keterangan}}</textarea>
							</div>
						</div>
						<div class="row">
