				...
				<div class="panel-body">
					<form class="form-horizontal row-border" action="{{ Route('submit-Edit-Pegawai', ['Id' => HCrypt::Encrypt($Pegawai->id)]) }}" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<input type="text" name="nip" class="form-control" minlength="18" maxlength="18" required pattern="[0-9\s]{18,18}" value="{{$Pegawai->nip}}" onkeypress="return hanyaAngka(event)">
							</div>
						</div>
						<div class="form-group">
